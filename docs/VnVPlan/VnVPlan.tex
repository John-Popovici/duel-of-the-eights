...
\begin{itemize}
    ...
    \item \textbf{How test will be performed:} Test evaluates various combinations to ensure scoring accuracy.
\end{itemize}
...
\paragraph{Test: Game Settings Modification}
\begin{itemize}
    \item \textbf{Test ID:} Test-5
    \item \textbf{Control:} Manual
    \item \textbf{Initial State:} Game settings menu open.
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|}
        ...
        Test-4 & R7: Dice selection functionality \\
        Test-5 & R9: Game settings modification \\
        Test-6 & NFR1: Frame rate consistency \\
        Test-7 & NFR5: Input responsiveness \\
        Test-8 & NFR3: Windows 10 compatibility, NFR10: MacOS support \\
        Test-9 & NFR4: Multiplayer stability \\
        \hline
    \end{tabular}
