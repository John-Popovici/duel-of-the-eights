...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Through this, the systems modularity will be displayed.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item This will show how the system perserves game data. 
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item This will highlight how data is synchronized between both players and game integrity is perserved.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item This will showcase the systems ridgity and stability.
    \end{itemize}
\end{enumerate}
